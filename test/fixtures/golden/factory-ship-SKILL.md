...
If `SKILL_PREFIX` is `"true"`, suggest/invoke `/g6-*` names. Disk paths stay `$GSTACK_ROOT/[skill-name]/SKILL.md`.
...
> This project has g6 vendored in `.factory/skills/gstack/`. Vendoring is deprecated.
