...
description: |
  ...
  PDF", "turn this markdown into a PDF", or "generate a document". (g6)
...
~/.claude/skills/g6/bin/gstack-timeline-log '{"skill":"make-pdf","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
[ -z "$P" ] && [ -n "$_ROOT" ] && [ -x "$_ROOT/.claude/skills/g6/make-pdf/dist/pdf" ] && P="$_ROOT/.claude/skills/g6/make-pdf/dist/pdf"
[ -z "$P" ] && P="$HOME/.claude/skills/g6/make-pdf/dist/pdf"
if [ -x "$P" ]; then
