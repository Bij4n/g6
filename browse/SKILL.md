...
description: |
  ...
  site", "take a screenshot", or "dogfood this". (g6)
triggers:
  - browse a page
  - headless browser
...
~/.claude/skills/g6/bin/gstack-timeline-log '{"skill":"browse","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
`$B` is the browse binary (resolved from `$_ROOT/.claude/skills/g6/browse/dist/browse` or `~/.claude/skills/g6/browse/dist/browse`).
