...
version: 1.0.0
description: |
  Manage project learnings. Review, search, prune, and export what g6
...
~/.claude/skills/g6/bin/gstack-timeline-log '{"skill":"learn","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
~/.claude/skills/g6/bin/gstack-question-log '{"skill":"learn","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
see what g6 has learned across sessions on this project, search for relevant
...
```bash
eval "$(~/.claude/skills/g6/bin/gstack-slug 2>/dev/null)"
~/.claude/skills/g6/bin/gstack-learnings-search --limit 20 2>/dev/null || echo "No learnings yet."
```
...
g6 will automatically capture patterns, pitfalls, and insights it discovers."
...
```bash
eval "$(~/.claude/skills/g6/bin/gstack-slug 2>/dev/null)"
~/.claude/skills/g6/bin/gstack-learnings-search --query "USER_QUERY" --limit 20 2>/dev/null || echo "No matches."
```
...
```bash
eval "$(~/.claude/skills/g6/bin/gstack-slug 2>/dev/null)"
~/.claude/skills/g6/bin/gstack-learnings-search --limit 100 2>/dev/null
```
...
```bash
eval "$(~/.claude/skills/g6/bin/gstack-slug 2>/dev/null)"
~/.claude/skills/g6/bin/gstack-learnings-search --limit 50 2>/dev/null
```
...
```bash
~/.claude/skills/g6/bin/gstack-learnings-log '{"skill":"learn","type":"TYPE","key":"KEY","insight":"INSIGHT","confidence":N,"source":"user-stated","files":["FILE1"]}'
```
